...
PathCondAllocator::evaluateTestNullLikeExpr(const BranchStmt *branchStmt, const BasicBlock *succ) {
 ...
 */
PathCondAllocator::Condition
PathCondAllocator::getPHIComplementCond(const BasicBlock *BB1, const BasicBlock *BB2, const BasicBlock *BB0) {
 ...
 */
PathCondAllocator::Condition
PathCondAllocator::ComputeInterCallVFGGuard(const BasicBlock *srcBB, const BasicBlock *dstBB,
 ...
 */
PathCondAllocator::Condition
PathCondAllocator::ComputeInterRetVFGGuard(const BasicBlock *srcBB, const BasicBlock *dstBB, const BasicBlock *retBB) {
...
PathCondAllocator::Condition PathCondAllocator::newCond(const Instruction *inst) {
...
void PathCondAllocator::extractSubConds(const Condition &condition, NodeBS &support) const {
