...
void TypeBasedHeapCloning::validateTBHCTests(SVFModule*)
{
    ...
    for (u32_t i = 0; i < llvmModuleSet->getModuleNum(); ++i)
    {
        ...
        for (const CallBlockNode *cbn : callSites)
        {
            ...
            {
                passed = res == llvm::AliasResult::Kind::MayAlias || res == llvm::AliasResult::Kind::MustAlias;
            ...
            {
                passed = res == llvm::AliasResult::Kind::NoAlias;
            ...
            {
                passed = res == llvm::AliasResult::Kind::MustAlias || res == llvm::AliasResult::Kind::MayAlias;
            ...
            {
                passed = res == llvm::AliasResult::Kind::MayAlias || res == llvm::AliasResult::Kind::PartialAlias;
            ...
            {
                passed = res != llvm::AliasResult::Kind::MayAlias && res != llvm::AliasResult::Kind::MustAlias && res != llvm::AliasResult::Kind::PartialAlias;
