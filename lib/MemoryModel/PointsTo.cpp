...
void PointsTo::intersectWithComplement(const PointsTo &lhs,
                                       const PointsTo &rhs) {
  assert(
      metaSame(rhs) &&
      "PointsTo::intersectWithComplement: mappings of operands do not match!");
...
PointsTo::PointsToIterator::operator=(const PointsToIterator &rhs) {
  this->pt = rhs.pt;
...
PointsTo::PointsToIterator &
PointsTo::PointsToIterator::operator=(PointsToIterator &&rhs) {
  this->pt = rhs.pt;
