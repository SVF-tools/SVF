 ...
 */
SVFStmt *IRGraph::hasNonlabeledEdge(SVFVar *src, SVFVar *dst,
                                    SVFStmt::PEDGEK kind) {
 ...
 */
SVFStmt *IRGraph::hasLabeledEdge(SVFVar *src, SVFVar *op1, SVFStmt::PEDGEK kind,
                                 const SVFVar *op2) {
 ...
 */
SVFStmt *IRGraph::hasLabeledEdge(SVFVar *src, SVFVar *dst, SVFStmt::PEDGEK kind,
 ...
 * View IRGraph
 */
void IRGraph::view() { llvm::ViewGraph(this, "ProgramAssignmentGraph"); }
...
/// instruction
static std::string
getNodeLabel(SVFVar *node, IRGraph *) {
  std::string str;
