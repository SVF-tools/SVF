 ...
 */
void DistinctMRG::createDistinctMR(const CallGraphNode* func, const NodeBS& pts)
{
    /// Create memory regions for each points-to target.
 ...
 */
void DistinctMRG::getMRsForLoad(MRSet& mrs, const NodeBS& pts, const CallGraphNode*)
{
 ...
 */
void DistinctMRG::getMRsForCallSiteRef(MRSet& aliasMRs, const NodeBS& cpts, const CallGraphNode* fun)
{
 ...
 * Create memory regions for each points-to target.
 */
void IntraDisjointMRG::createDisjointMR(const CallGraphNode* func, const NodeBS& cpts)
{
    // set the rep cpts as itself.
 ...
 * Just process as getMRsForLoad().
 */
void IntraDisjointMRG::getMRsForCallSiteRef(MRSet& aliasMRs, const NodeBS& cpts, const CallGraphNode* fun)
{
    getMRsForLoad(aliasMRs, cpts, fun);
}
