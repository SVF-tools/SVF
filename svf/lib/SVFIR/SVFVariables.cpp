...
RetPN::RetPN(const CallGraphNode* node, NodeID i) : ValVar(nullptr, i, RetNode), callGraphNode(node) {
...
{
    return getFunction()->isIntrinsic();
}

const SVFFunction* FuncObjVar::getFunction() const
{
