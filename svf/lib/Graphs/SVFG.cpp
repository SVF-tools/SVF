...
const std::string ActualINSVFGNode::toString() const
{
    std::string str;
    std::stringstream rawstr(str);
    rawstr << "ActualINSVFGNode ID: " << getId() << " at callsite: " <<  ((SVFBaseNode*) getCallSite())->toString() << " {fun: " << getFun()->getName() << "}";
...
const std::string ActualOUTSVFGNode::toString() const
{
    std::string str;
    std::stringstream rawstr(str);
    rawstr << "ActualOUTSVFGNode ID: " << getId() << " at callsite: " <<  ((SVFBaseNode*) getCallSite())->toString() << " {fun: " << getFun()->getName() << "}";
    rawstr <<  getMRVer()->getMR()->getMRID() << "V_" << getMRVer()->getSSAVersion() <<
...
const std::string InterMSSAPHISVFGNode::toString() const
{
    ...
    if(isFormalINPHI())
        ...
        rawstr << "ActualOUTPHISVFGNode ID: " << getId() << " at callsite: " <<  ((SVFBaseNode*) getCallSite())->toString() << " {fun: " << getFun()->getName() << "}";
    rawstr << MSSAPHISVFGNode::toString();
    return rawstr.str();
}
