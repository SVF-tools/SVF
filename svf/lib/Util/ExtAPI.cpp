...
static const ei_pair ei_pairs[]=
{
    ...
    {"ngx_alloc", ExtAPI::EFT_ALLOC},
    {"ngx_array_create", ExtAPI::EFT_ALLOC},
    {"ngx_calloc", ExtAPI::EFT_ALLOC},
    {"ngx_palloc", ExtAPI::EFT_ALLOC},
    {"ngx_palloc_small", ExtAPI::EFT_ALLOC},
    {"ngx_pcalloc", ExtAPI::EFT_ALLOC},
    {"ngx_pnalloc", ExtAPI::EFT_ALLOC},
    {"ngx_resolver_alloc", ExtAPI::EFT_ALLOC},
    {"ngx_resolver_calloc", ExtAPI::EFT_ALLOC},
    {"ngx_slab_alloc", ExtAPI::EFT_ALLOC},
    {"ngx_slab_calloc_locked", ExtAPI::EFT_ALLOC},
    {"ngx_palloc_large", ExtAPI::EFT_ALLOC},
    {"ngx_create_pool", ExtAPI::EFT_ALLOC},
    ...
    {"kmalloc_array", ExtAPI::EFT_ALLOC},
    {"krealloc_array", ExtAPI::EFT_ALLOC},
    {"kcalloc", ExtAPI::EFT_ALLOC},
    {"kzalloc", ExtAPI::EFT_ALLOC},
    {"kzalloc_node", ExtAPI::EFT_ALLOC},
    {"kmem_cache_alloc", ExtAPI::EFT_ALLOC},
    {"kmem_cache_alloc_node", ExtAPI::EFT_ALLOC},
    {"krealloc", ExtAPI::EFT_ALLOC},
    {"kvmalloc_node", ExtAPI::EFT_ALLOC},
    {"vmap", ExtAPI::EFT_ALLOC},
    {"vmap_pfn", ExtAPI::EFT_ALLOC},
    {"vmalloc", ExtAPI::EFT_ALLOC},
    {"vmalloc_no_huge", ExtAPI::EFT_ALLOC},
    {"vzalloc", ExtAPI::EFT_ALLOC},
    {"vmalloc_user", ExtAPI::EFT_ALLOC},
    {"vmalloc_node", ExtAPI::EFT_ALLOC},
    {"vzalloc_node", ExtAPI::EFT_ALLOC},
    {"vmalloc_32", ExtAPI::EFT_ALLOC},
    {"vmalloc_32_user", ExtAPI::EFT_ALLOC},
    {"__kmalloc", ExtAPI::EFT_ALLOC},
    {"__kcalloc", ExtAPI::EFT_ALLOC},
    {"__kzalloc", ExtAPI::EFT_ALLOC},
    ...
    /*
    {"ngx_array_push", ExtAPI::EFT_L_A0},
    {"ngx_array_push_n", ExtAPI::EFT_L_A0},
    {"ngx_list_push", ExtAPI::EFT_L_A0},
    */
