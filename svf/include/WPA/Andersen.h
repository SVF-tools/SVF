...
public:
    ...
    virtual void connectCaller2ForkedFunParams(const CallICFGNode* cs, const CallGraphNode* cgNode,
            NodePairSet& cpySrcNodes);

    /// Connect formal and actual parameters for indirect callsites
    virtual void connectCaller2CalleeParams(const CallICFGNode* cs, const CallGraphNode* F,
                                            NodePairSet& cpySrcNodes);
