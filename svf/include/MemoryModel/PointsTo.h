...
public:
    ...
    /// Put intersection of lhs with complement of rhs into this set
    /// (overwrites).
    ...
    static void setCurrentBestNodeMapping(
...
private:
    ...
    /// Returns true if this points-to set and pt have the same type,
    /// nodeMapping, and reverseNodeMapping
