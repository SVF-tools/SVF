...
private:
    const SVFValueNode* gNode; // constant, gepValvar, retPN, dummy could be null
protected:
...
public:
    ...
    /// Constructor
    ValVar(const SVFValue* val, NodeID i, PNODEK ty = ValNode, const SVFValueNode* node = nullptr)
    ...
    const SVFValueNode* getGNode() const {
        return gNode;
    }
