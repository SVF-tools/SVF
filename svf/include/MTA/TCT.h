...
public:
    ...
    typedef Map<CxtThread,const CallGraphNode*> CxtThreadToFun;
    ...
    inline bool isCandidateFun(const CallGraphNode* fun) const
    {
    ...
    const CallGraphNode* getStartRoutineOfCxtThread(const CxtThread& ct) const
    {
    ...
    void pushCxt(CallStrCxt& cxt, const CallICFGNode* call, const CallGraphNode* callee);
    /// Match context
    bool matchCxt(CallStrCxt& cxt, const CallICFGNode* call, const CallGraphNode* callee);
...
private:
    ...
    //@{
    void markRelProcs();
    void markRelProcs(const CallGraphNode* cgFun);
    //@}
    ...
    //@{
    inline TCTNode* getOrCreateTCTNode(const CallStrCxt& cxt, const ICFGNode* fork,const CallStrCxt& oldCxt, const CallGraphNode* routine)
    {
    ...
    void addStartRoutineOfCxtThread(const CallGraphNode* fun, const CxtThread& ct)
    {
