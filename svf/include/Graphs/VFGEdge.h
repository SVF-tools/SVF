...
public:
    ...
    {
        return getEdgeKind() == IntraIndirectVF || getEdgeKind() == CallIndVF || getEdgeKind() == RetIndVF ||
               getEdgeKind() == TheadMHPIndirectVF;
    }
...
public:
    ...
    {
        return edge->getEdgeKind() == IntraDirectVF || edge->getEdgeKind() == CallDirVF ||
