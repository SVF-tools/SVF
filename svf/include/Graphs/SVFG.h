...
public:
    ...
    typedef Map<const CallGraphNode*, FormalINSVFGNodeSet>  FunctionToFormalINsMapTy;
    typedef Map<const CallGraphNode*, FormalOUTSVFGNodeSet>  FunctionToFormalOUTsMapTy;
...
public:
    ...
    void getInterVFEdgesForIndirectCallSite(const CallICFGNode* cs, const CallGraphNode* callee, SVFGEdgeSetTy& edges);

    /// Dump graph into dot file
    void dump(const std::string& file, bool simple = false);

    /// Connect SVFG nodes between caller and callee for indirect call site
    virtual void connectCallerAndCallee(const CallICFGNode* cs, const CallGraphNode* callee, SVFGEdgeSetTy& edges);
    ...
    inline bool hasFormalINSVFGNodes(const CallGraphNode* fun) const
    {
        return funToFormalINMap.find(fun)!=funToFormalINMap.end();
    }

    inline bool hasFormalOUTSVFGNodes(const CallGraphNode* fun) const
    {
    ...
    inline FormalINSVFGNodeSet& getFormalINSVFGNodes(const CallGraphNode* fun)
    {
        return funToFormalINMap[fun];
    }

    inline FormalOUTSVFGNodeSet& getFormalOUTSVFGNodes(const CallGraphNode* fun)
    {
...
protected:
    ...
    virtual inline void getInterVFEdgeAtIndCSFromAInToFIn(ActualINSVFGNode* actualIn, const CallGraphNode* callee, SVFGEdgeSetTy& edges)
    {
    ...
    virtual inline void getInterVFEdgeAtIndCSFromFOutToAOut(ActualOUTSVFGNode* actualOut, const CallGraphNode* callee, SVFGEdgeSetTy& edges)
    {
    ...
    //@{
    inline bool hasFuncEntryChi(const CallGraphNode*  func) const
    {
        return (funToFormalINMap.find(func) != funToFormalINMap.end());
    }
    inline bool hasFuncRetMu(const CallGraphNode*  func) const
    {
