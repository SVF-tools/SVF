...
public:
    SVFBugEvent(u32_t typeAndInfoFlag, const SVFInstruction* eventInst)
...
public:
    ...
    GenericBug(BugType bugType, const EventStack& bugEventStack) : bugType(bugType), bugEventStack(bugEventStack)
    {
...
public:
    BufferOverflowBug(GenericBug::BugType bugType, const EventStack& eventStack, s64_t allocLowerBound,
                      s64_t allocUpperBound, s64_t accessLowerBound, s64_t accessUpperBound)
        : GenericBug(bugType, eventStack), allocLowerBound(allocLowerBound), allocUpperBound(allocUpperBound),
          accessLowerBound(accessLowerBound), accessUpperBound(accessUpperBound)
    {
    }
...
{
public:
    FullBufferOverflowBug(const EventStack& eventStack, s64_t allocLowerBound, s64_t allocUpperBound,
                          s64_t accessLowerBound, s64_t accessUpperBound)
        : BufferOverflowBug(GenericBug::FULLBUFOVERFLOW, eventStack, allocLowerBound, allocUpperBound, accessLowerBound,
                            accessUpperBound)
    {
    }
...
{
public:
    PartialBufferOverflowBug(const EventStack& eventStack, s64_t allocLowerBound, s64_t allocUpperBound,
                             s64_t accessLowerBound, s64_t accessUpperBound)
        : BufferOverflowBug(GenericBug::PARTIALBUFOVERFLOW, eventStack, allocLowerBound, allocUpperBound,
                            accessLowerBound, accessUpperBound)
    {
    }
...
{
public:
    NeverFreeBug(const EventStack& bugEventStack) : GenericBug(GenericBug::NEVERFREE, bugEventStack){};
...
{
public:
    PartialLeakBug(const EventStack& bugEventStack) : GenericBug(GenericBug::PARTIALLEAK, bugEventStack) {}
...
{
public:
    DoubleFreeBug(const EventStack& bugEventStack) : GenericBug(GenericBug::DOUBLEFREE, bugEventStack) {}
...
{
public:
    FileNeverCloseBug(const EventStack& bugEventStack) : GenericBug(GenericBug::FILENEVERCLOSE, bugEventStack){};
...
{
public:
    FilePartialCloseBug(const EventStack& bugEventStack) : GenericBug(GenericBug::FILEPARTIALCLOSE, bugEventStack) {}
...
public:
     ...
     */
    void addAbsExecBug(GenericBug::BugType bugType, const GenericBug::EventStack& eventStack, s64_t allocLowerBound,
                       s64_t allocUpperBound, s64_t accessLowerBound, s64_t accessUpperBound)
    {
        /// add bugs
        GenericBug* newBug = nullptr;
        ...
        case GenericBug::FULLBUFOVERFLOW: {
            newBug = new FullBufferOverflowBug(eventStack, allocLowerBound, allocUpperBound, accessLowerBound,
                                               accessUpperBound);
            bugSet.insert(newBug);
            break;
        }
        case GenericBug::PARTIALBUFOVERFLOW: {
            newBug = new PartialBufferOverflowBug(eventStack, allocLowerBound, allocUpperBound, accessLowerBound,
                                                  accessUpperBound);
            bugSet.insert(newBug);
            break;
        }
