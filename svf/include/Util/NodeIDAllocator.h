...
public:
    ...
    public:
        ...
        static std::vector<NodeID> cluster(BVDataPTAImpl* pta, const std::vector<std::pair<NodeID, unsigned>> keys,
        ...
        static void evaluate(const std::vector<NodeID>& nodeMap, const Map<PointsTo, unsigned> pointsToSets,
    ...
    private:
        ...
        static inline void traverseDendrogram(std::vector<NodeID>& nodeMap, const int* dendrogram,
        ...
        static inline std::vector<unsigned> regionObjects(const Map<NodeID, Set<NodeID>>& graph, size_t numObjects,
                                                          size_t& numLabels);
