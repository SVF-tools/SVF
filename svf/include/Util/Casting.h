...
template <typename From> struct simplify_type<const From>
{
    ...
    using SimpleType = typename SVFUtil::add_const_past_pointer<NonConstSimpleType>::type;
    using RetType = typename SVFUtil::add_lvalue_reference_if_not_pointer<SimpleType>::type;
...
template <typename To, typename From> struct isa_impl<To, From, std::enable_if_t<std::is_base_of<To, From>::value>>
{
...
template <typename First, typename Second, typename... Rest, typename Y> LLVM_NODISCARD inline bool isa(const Y& Val)
{
...
inline std::enable_if_t<!is_simple_type<Y>::value, typename cast_retty<X, const Y>::ret_type> cast(const Y& Val)
{
...
template <class X, class Y>
LLVM_NODISCARD inline std::enable_if_t<!is_simple_type<Y>::value, typename cast_retty<X, const Y>::ret_type> dyn_cast(
    const Y& Val)
{
