...
public:
    ...
    AbstractState abstract_consequence(const AbstractState& lower, const AbstractState& upper,
    ...
    Map<u32_t, s32_t> BoxedOptSolver(const Z3Expr& phi, Map<u32_t, s32_t>& ret, Map<u32_t, s32_t>& low_values,
    ...
    void decide_cpa_ext(const Z3Expr& phi, Map<u32_t, Z3Expr>&, Map<u32_t, s32_t>&, Map<u32_t, s32_t>&,
                        Map<u32_t, s32_t>&, Map<u32_t, s32_t>&);
};
} // namespace SVF
