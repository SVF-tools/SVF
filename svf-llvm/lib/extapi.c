...
*/
__attribute__((annotate("ALLOC_RET"), annotate("Arg0"), annotate("Arg1")))
void *malloc(unsigned long size)
{
    return NULL;
}

__attribute__((annotate("ALLOC_RET"), annotate("UNKNOWN")))
...
__attribute__((annotate("ALLOC_RET"), annotate("Arg0")))
...
__attribute__((annotate("ALLOC_RET"), annotate("Arg1")))
...
__attribute__((annotate("REALLOC_RET"), annotate("UNKNOWN")))
char *getcwd(char *buf, unsigned long size)
{
    return NULL;
}

__attribute__((annotate("REALLOC_RET"), annotate("Arg1")))
...
__attribute__((annotate("REALLOC_RET"), annotate("Arg1"), annotate("Arg2")))
...
__attribute__((annotate("ALLOC_ARG0"), annotate("UNKNOWN")))
...
__attribute__((annotate("ALLOC_ARG0"), annotate("Arg2")))
int posix_memalign(void **a, unsigned long b, unsigned long c)
{
    return 0;
}

__attribute__((annotate("ALLOC_ARG1"), annotate("UNKNOWN")))
...
__attribute__((annotate("ALLOC_ARG2"), annotate("UNKNOWN")))
