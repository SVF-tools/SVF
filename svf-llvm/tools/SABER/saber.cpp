...
int main(int argc, char** argv)
{
    ...
    moduleNameVec = OptionBase::parseOptions(argc, argv, "Source-Sink Bug Detector", "[options] <input-bitcode...>");
    ...
    if (Options::MemoryLeakCheck()) saber = std::make_unique<LeakChecker>();
