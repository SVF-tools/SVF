...
public:
  ...
  /// Interface of mod-ref analysis to determine whether a CallSite instruction
  /// can mod or ref any memory location
  virtual ModRefInfo getModRefInfo(const CallInst *callInst);

  /// Interface of mod-ref analysis to determine whether a CallSite instruction
  /// can mod or ref a specific memory location, given Location infos
  ...
  /// Interface of mod-ref analysis to determine whether a CallSite instruction
  /// can mod or ref a specific memory location, given Value infos
  ...
  /// PTA name
  virtual inline StringRef getPassName() const { return "WPAPass"; }
