...
protected:
  ...
  /// Returns the original object c is cloned from. If c is not a clone, returns
  /// itself.
  ...
  /// indicates whether reuse is a possibility for this initialisation. Returns
  /// whether p changed.
...
private:
  ...
  /// Maps nodes (a location like a SVFIR node or SVFG node) to their filter
  /// set.
