...
public:
  ...
  /// processLoad takes, for example (many calls), but want to know things like
  /// total solve time. Should be used only to affect getClk, not CLOCK_IN_MS.
  ...
  ///       Clusterer::cluster directly, but it seems we will always want single
  ///       anyway, and this is for testing.
