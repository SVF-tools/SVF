...
protected:
  ...
  virtual void getMRsForLoad(MRSet &aliasMRs, const NodeBS &cpts,
                             const SVFFunction *fun);

  /// Get memory regions to be inserted at a load statement.
  virtual void getMRsForCallSiteRef(MRSet &aliasMRs, const NodeBS &cpts,
                                    const SVFFunction *fun);
...
protected:
  ...
  void getMRsForLoadFromInterList(MRSet &mrs, const NodeBS &cpts,
