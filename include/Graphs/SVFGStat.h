...
public:
  ...
  void dirVFEdgeStart() { connectDirSVFGEdgeTimeStart = PTAStat::getClk(true); }

  void dirVFEdgeEnd() { connectDirSVFGEdgeTimeEnd = PTAStat::getClk(true); }

  void indVFEdgeStart() { connectIndSVFGEdgeTimeStart = PTAStat::getClk(true); }

  void indVFEdgeEnd() { connectIndSVFGEdgeTimeEnd = PTAStat::getClk(true); }

  void TLVFNodeStart() { addTopLevelNodeTimeStart = PTAStat::getClk(true); }

  void TLVFNodeEnd() { addTopLevelNodeTimeEnd = PTAStat::getClk(true); }

  void ATVFNodeStart() { addAddrTakenNodeTimeStart = PTAStat::getClk(true); }

  void ATVFNodeEnd() { addAddrTakenNodeTimeEnd = PTAStat::getClk(true); }

  void sfvgOptStart() { svfgOptTimeStart = PTAStat::getClk(true); }

  void sfvgOptEnd() { svfgOptTimeEnd = PTAStat::getClk(true); }
