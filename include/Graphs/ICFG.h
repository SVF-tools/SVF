...
private:
  FunToFunEntryNodeMapTy
      FunToFunEntryNodeMap; ///< map a function to its FunExitICFGNode
  FunToFunExitNodeMapTy
      FunToFunExitNodeMap;           ///< map a function to its FunEntryICFGNode
...
public:
  ...
  inline GlobalICFGNode *getGlobalICFGNode() const { return globalBlockNode; }
  //@}
