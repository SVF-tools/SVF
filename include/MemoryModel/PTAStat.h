...
public:
  ...
  static const char
      *NumOfObjsHasVarStruct; ///< SVFIR object node has var struct (maybe
                              ///< nested with array)
  static const char *NumOfObjsHasVarArray; ///< SVFIR object node has var array
                                           ///< (maybe nested with struct)
  static const char
      *NumOfObjsHasConstStruct; ///< SVFIR object node has const struct (maybe
                                ///< nested with array)
  static const char
      *NumOfObjsHasConstArray; ///< SVFIR object node has const array (maybe
                               ///< nested with struct)
  static const char *NumOfNonPtrObjs; ///< SVFIR object node which is non
                                      ///< pointer type object (do not have pts)
  static const char
      *NumOfConstantObjs; ///< SVFIR object node which is purely constant

  static const char *NumberOfFieldInsensitiveObj;
  static const char *NumberOfFieldSensitiveObj;

  static const char
      *NumOfPointers; ///< SVFIR value node, each of them maps to a llvm value
  static const char
      *NumOfGepFieldPointers; ///< SVFIR gep value node (field value,
                              ///< dynamically created dummy node)

  static const char *
      NumOfMemObjects; ///< SVFIR object node, each of them maps to a llvm value
  static const char
      *NumOfGepFieldObjects; ///< SVFIR gep object node (field obj, dynamically
                             ///< created dummy node)
  ...
  virtual inline void startClk() { startTime = getClk(true); }
  virtual inline void endClk() { endTime = getClk(true); }
