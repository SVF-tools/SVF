...
/// Context Insensitive			   Key --> Variable, DataSet -->
/// PointsTo
/// Context sensitive:  			   Key --> CondVar,  DataSet -->
/// PointsTo
/// Heap sensitive:     			   Key --> Variable  DataSet -->
/// CondPointsToSet Context and heap sensitive:     Key --> CondVar,  DataSet
/// --> CondPointsToSet
///
