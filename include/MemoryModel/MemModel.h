...
public:
    ...
    /// Get a subType of a type of a base object (all its subtypes are flattened)
    const inline llvm::Type* getFlattenSubType(const llvm::Type* baseType, u32_t fieldIndex){
