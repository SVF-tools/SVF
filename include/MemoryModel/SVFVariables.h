...
public:
  ...
  virtual inline bool isPointer() const { return isPtr; }
  ...
  /// Return the function that this SVFVar resides in. Return nullptr if it is a
  /// global or constantexpr node
  ...
  inline SVFStmt::SVFStmtSetTy::iterator
  getIncomingEdgesBegin(SVFStmt::PEDGEK kind) const {
    SVFStmt::KindToSVFStmtMapTy::const_iterator it =
        InEdgeKindToSetMap.find(kind);
  ...
  /// Get incoming SVFStmt iterator
  inline SVFStmt::SVFStmtSetTy::iterator
  getIncomingEdgesEnd(SVFStmt::PEDGEK kind) const {
    SVFStmt::KindToSVFStmtMapTy::const_iterator it =
        InEdgeKindToSetMap.find(kind);
    assert(it != InEdgeKindToSetMap.end() &&
           "The node does not have such kind of edge");
  ...
  inline SVFStmt::SVFStmtSetTy::iterator
  getOutgoingEdgesBegin(SVFStmt::PEDGEK kind) const {
    SVFStmt::KindToSVFStmtMapTy::const_iterator it =
        OutEdgeKindToSetMap.find(kind);
  ...
  /// Get outgoing SVFStmt iterator
  inline SVFStmt::SVFStmtSetTy::iterator
  getOutgoingEdgesEnd(SVFStmt::PEDGEK kind) const {
    SVFStmt::KindToSVFStmtMapTy::const_iterator it =
        OutEdgeKindToSetMap.find(kind);
    assert(it != OutEdgeKindToSetMap.end() &&
           "The node does not have such kind of edge");
...
public:
  ...
  //@{
  static inline bool classof(const ValVar *) { return true; }
...
public:
  /// Methods for support type inquiry through isa, cast, and dyn_cast:
  //@{
  static inline bool classof(const ObjVar *) { return true; }
  static inline bool classof(const SVFVar *node) {
  ...
  /// Return type of the value
  inline virtual const llvm::Type *getType() const { return mem->getType(); }
...
public:
  /// Methods for support type inquiry through isa, cast, and dyn_cast:
  //@{
  static inline bool classof(const GepValVar *) { return true; }
...
public:
  /// Methods for support type inquiry through isa, cast, and dyn_cast:
  //@{
  static inline bool classof(const GepObjVar *) { return true; }
  ...
  inline virtual const Type *getType() const {
    return SymbolTableInfo::SymbolInfo()->getFlatternedElemType(
        mem->getType(), ls.accumulateConstantFieldIdx());
  }
  ...
  inline const std::string getValueName() const {
    if (value && value->hasName())
      return value->getName().str() + "_" +
             std::to_string(ls.accumulateConstantFieldIdx());
...
/*
 * Field-insensitive Gep Obj variable, this is dynamic generated for field
 * sensitive analysis Each field-insensitive gep obj node represents all fields
 * of a MemObj (base)
 */
...
public:
  ///  Methods for support type inquiry through isa, cast, and dyn_cast:
  //@{
  static inline bool classof(const FIObjVar *) { return true; }
  static inline bool classof(const ObjVar *node) {
...
public:
  //@{ Methods for support type inquiry through isa, cast, and dyn_cast:
  static inline bool classof(const DummyValVar *) { return true; }
  static inline bool classof(const SVFVar *node) {
  ...
  inline const std::string getValueName() const { return "dummyVal"; }
...
public:
  //@{ Methods for support type inquiry through isa, cast, and dyn_cast:
  static inline bool classof(const DummyObjVar *) { return true; }
  static inline bool classof(const SVFVar *node) {
  ...
  /// Return name of this node
  inline const std::string getValueName() const { return "dummyObj"; }
...
public:
  ...
  static inline bool classof(const CloneDummyObjVar *) { return true; }
  static inline bool classof(const SVFVar *node) {
...
public:
  //@{ Methods to support type inquiry through isa, cast, and dyn_cast:
  static inline bool classof(const CloneGepObjVar *) { return true; }
  static inline bool classof(const SVFVar *node) {
  ...
  /// Constructor
  CloneGepObjVar(const MemObj *mem, NodeID i, const LocationSet &l,
...
public:
  //@{ Methods to support type inquiry through isa, cast, and dyn_cast:
  static inline bool classof(const CloneFIObjVar *) { return true; }
  static inline bool classof(const SVFVar *node) {
  ...
  /// Constructor
  CloneFIObjVar(const Value *val, NodeID i, const MemObj *mem,
