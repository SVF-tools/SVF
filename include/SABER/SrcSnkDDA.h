...
public:
  ...
  /// Get SVFIR
  SVFIR *getPAG() const { return SVFIR::getPAG(); }
  ...
  virtual bool isSourceLikeFun(const SVFFunction *fun) { return false; }

  virtual bool isSinkLikeFun(const SVFFunction *fun) { return false; }
...
protected:
  ...
  virtual bool isSomePathReachable() { return _curSlice->isPartialReachable(); }
