...
public:
  ...
  typedef Map<const SVFGNode *, Condition *>
      SVFGNodeToCondMap; ///< map a SVFGNode to its condition during value-flow
                         ///< guard computation
  ...
  inline SVFGNodeSetIter forwardSliceEnd() const { return forwardslice.end(); }
  ...
  inline Condition *getTrueCond() const { return pathAllocator->getTrueCond(); }
