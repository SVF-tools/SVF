...
public:
  ...
  /// Classof
  //@{
  static inline bool classof(const TCTEdge *) { return true; }
...
public:
  ...
  /// Get SVFFModule
  SVFModule *getSVFModule() const { return pta->getModule(); }
...
private:
  ...
  /// Get entry functions that are neither called by other functions nor extern
  /// functions
