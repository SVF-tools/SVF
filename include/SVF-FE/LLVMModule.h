...
public:
  ...
  bool allCTir(void) const {
    // Iterate over all modules. If a single module does not have the correct
    // ctir module flag, short-circuit and return false.
    for (u32_t i = 0; i < getModuleNum(); ++i) {
      ...
      llvm::ConstantAsMetadata *flagConstMetadata =
