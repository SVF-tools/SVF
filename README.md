...
<br />
<br />
We release SVF source code with the hope to benefit others. You are kindly asked to acknowledge usage of the tool by citing some of our publications listed in the 
[homepage](http://svf-tools.github.io/SVF), especially the following two papers:
