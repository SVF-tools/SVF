...
SVFHOME=$(pwd)
sysOS=`uname -s`
MacLLVM="https://github.com/llvm/llvm-project/releases/download/llvmorg-12.0.0-rc3/clang+llvm-12.0.0-rc3-x86_64-apple-darwin.tar.xz"
UbuntuLLVM="https://github.com/llvm/llvm-project/releases/download/llvmorg-12.0.0-rc5/clang+llvm-12.0.0-rc5-x86_64-linux-gnu-ubuntu-20.10.tar.xz"
