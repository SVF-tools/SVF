...
UbuntuArmLLVM_RTTI="https://github.com/bjjwwang/SVF-LLVM/releases/download/22.1.0/llvm-${LLVMVer}-ubuntu22-rtti-aarch64.tar.gz"
...
UbuntuLLVM_RTTI="https://github.com/bjjwwang/SVF-LLVM/releases/download/22.1.0/llvm-${LLVMVer}-ubuntu22-rtti-x86-64.tar.gz"
